...
return [
    ...
    'products' => [
        ...
        'create' => [
            ...
            'general'           => 'General',
            'price'             => 'Price',
            'image-product'     => 'Images of Product',
            'upload-image-info' => 'Upload product images (110px X 110px) in PNG or JPG format. The first image will automatically become the thumbnail.',
        ],
        'edit' => [
            'title'     => 'Edit Products',
            'save-btn'  => 'Save Products',
