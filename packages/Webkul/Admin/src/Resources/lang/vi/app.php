...
return [
    ...
    'products' => [
        ...
        'create' => [
            ...
            'price'             => 'Giá',
            'image-product'     => 'Hình ảnh sản phẩm',
            'upload-image-info' => 'Tải lên Ảnh sản phẩm (110px X 110px) ở định dạng PNG hoặc JPG. Ảnh đầu tiên sẽ tự động trở thành Thumbnail.',
        ],
        'edit' => [
    ...
    'tasks' => [
        'index' => [
            'title'                => 'Công việc',
            'create-btn'           => 'Tạo công việc',
            'create-success'       => 'Tạo công việc thành công.',
            'update-success'       => 'Cập nhật công việc thành công.',
