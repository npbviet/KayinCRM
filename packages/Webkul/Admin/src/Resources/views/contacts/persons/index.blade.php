        ...
        >
            ...
            >
                <template #header="{
                    ...
                    <template v-else>
                        <div class="row grid grid-cols-[.2fr_.5fr_.5fr_.4fr_.4fr_.3fr_.4fr_.3fr] grid-rows-1 items-center border-b px-4 py-2.5 dark:border-gray-800 max-lg:hidden">
                            <div
                                class="flex select-none items-center gap-2.5"
                                v-for="(columnGroup, index) in [['id'], ['person_name'], ['emails'], ['contact_numbers'], ['organization'], ['completed_leads_count'], ['completed_leads_value']]"
                                :class="{
                                    'justify-center': index === 5,
                                    'justify-end': index === 6,
                                }"
                            >
                                <label
                ...
                <template #body="{
                    ...
                    <template v-else>
                        <div
                            class="row grid grid-cols-[.2fr_.5fr_.5fr_.4fr_.4fr_.3fr_.4fr_.3fr] grid-rows-1 border-b px-4 py-2.5 transition-all hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-950 max-lg:hidden"
                        ...
                        >
                            ...
                            <p class="flex items-center justify-center dark:text-gray-300">
                                @{{ record.completed_leads_count }}
                            </p>

                            <p class="flex items-center justify-end dark:text-gray-300">
                                @{{ record.completed_leads_value }}
                            </p>
